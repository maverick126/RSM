...
namespace PresentationControls
{
    ...
    public partial class CheckBoxComboBox : PopupComboBox
    {
        ...
        protected void OnCheckBoxCheckedChanged(object sender, EventArgs e)
        {
            ...
            if (((CheckBox)sender).Text == "Select All")
            {
            ...
            {
                if (((System.Windows.Forms.ButtonBase)sender).Text != "Default")
                {
                    updateInProgress = true;
        ...
        /// Select / Unselect All
        /// </summary>
        public void AllSelection(bool allSelection)
        {
            foreach (CheckBoxComboBoxItem Item in CheckBoxItems)
                Item.Checked = allSelection;
            updateInProgress = false;
        }
        #endregion
