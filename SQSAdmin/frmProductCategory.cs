...
namespace SQSAdmin
{
    public partial class frmProductCategory : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter a valid category code!");
            }
            else
            {
                ...
                try
                {
                    DataSet dsTemp1 = MetriconCommon.DatabaseManager.ExecuteSQLQuery("select * from tblProductCategory where ProductCategoryCode='" + txtCode.Text.ToString().Trim() + "'");
                    if (dsTemp1.Tables[0].Rows.Count > 0)
                    {
                        MessageBox.Show("This category code already exists !");
                    }
                    else
                    {
                        DataSet dsTemp = MetriconCommon.DatabaseManager.ExecuteSQLQuery("[spa_AdminAddEditProductCategory]", new System.Data.SqlClient.SqlParameter[6]
                                {
        ...
        private void bindData(DataSet ds)
        {
            ...
            dataGridView1.Columns[0].HeaderText = "CategoryID";
        ...
        private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                codeID = Int32.Parse(dataGridView1.Rows[e.RowIndex].Cells["ProductCategoryID"].Value.ToString());
                ...
                code = dataGridView1.Rows[e.RowIndex].Cells["ProductCategoryCode"].Value.ToString();
                desc = dataGridView1.Rows[e.RowIndex].Cells["ProductCategoryDesc"].Value.ToString();
