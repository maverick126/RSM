    ...
    public partial class frmProductCode : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    DataSet dsTemp1 = MetriconCommon.DatabaseManager.ExecuteSQLQuery("select * from tblProductCode where ProductCode='" + txtCode.Text.ToString().Trim() + "'");
                    ...
                    {
                        DataSet dsTemp = MetriconCommon.DatabaseManager.ExecuteSQLQuery("[spa_AdminAddEditProductCode]", new System.Data.SqlClient.SqlParameter[6]
                                {
        ...
        private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                codeID = Int32.Parse(dataGridView1.Rows[e.RowIndex].Cells["ProductCodeID"].Value.ToString());
                ...
                code = dataGridView1.Rows[e.RowIndex].Cells["ProductCode"].Value.ToString();
                desc = dataGridView1.Rows[e.RowIndex].Cells["ProductCodeDesc"].Value.ToString();
